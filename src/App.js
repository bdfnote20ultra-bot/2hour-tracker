...
function MusicLibrarySidebar({ accentColor }) {
  ...
  useEffect(() => {
    ...
    const checkOwncastStatus = async () => {
      try {
        const response = await fetch("https://garlic-trigger-professor-alfred.trycloudflare.com/api/status", { cache: "no-store" });
  ...
  const liveTvOptions = [
    ...
    { id: "jellyfin", label: "FUIT JELLYFIN", heading: "FUIT JELLYFIN", url: "https://factory-coast-constraints-terry.trycloudflare.com/web/", embed: true },
              ...
              <>
                ...
                {(activeLiveTvOption.id === "jellyfin" || activeLiveTvOption.id === "athf") && (
                  <LiveChatBox
                    ...
                    src="https://safely-shirts-designation-cooked.trycloudflare.com/chat-only"
