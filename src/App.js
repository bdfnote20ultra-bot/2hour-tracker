            ...
            <div style={{ marginTop: 14, background: "#2C2C2E", borderRadius: 12, padding: "14px 16px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, color: "#888", marginTop: 8, fontFamily: "system-ui" }}>
                    Weekly OT Earned
                  </div>
                  <div style={{ fontSize: 13, color: overtimeMins > 0 ? accentColor : "#aaa", marginTop: 1, fontFamily: "system-ui" }}>
                    ${overtimePay || "0.00"}
                  </div>
                </div>
