      ...
      <style>{`
        ...
        @media (hover: none) and (pointer: coarse) and (orientation: landscape) and (max-width: 1100px) and (max-height: 560px) {
          :root {
            ...
            --flive-center-header-padding: 8px 12px 10px;
            ...
            --flive-center-stats-padding: 7px 8px;
            --flive-center-stats-gap: 5px;
