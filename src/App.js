...
function MusicLibrarySidebar({ accentColor }) {
  ...
  useEffect(() => {
    ...
    const checkOwncastStatus = async () => {
      try {
        const response = await fetch("https://only-enterprises-accepts-happen.trycloudflare.com/api/status", { cache: "no-store" });
  ...
  const liveTvOptions = [
    ...
    { id: "jellyfin", label: "FUIT JELLYFIN", heading: "FUIT JELLYFIN", url: "https://gloves-workshop-threatened-while.trycloudflare.com/web/", embed: true },
              ...
              <>
                ...
                {(activeLiveTvOption.id === "jellyfin" || activeLiveTvOption.id === "athf") && (
                  <LiveChatBox
                    ...
                    src="https://creating-density-nightlife-yrs.trycloudflare.com/chat-only"
