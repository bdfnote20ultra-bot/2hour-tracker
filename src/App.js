...
function MusicLibrarySidebar({ accentColor }) {
  ...
  useEffect(() => {
    ...
    const checkOwncastStatus = async () => {
      try {
        const response = await fetch("https://stored-limit-withdrawal-article.trycloudflare.com/api/status", { cache: "no-store" });
  ...
  const liveTvOptions = [
    ...
    { id: "jellyfin", label: "FUIT JELLYFIN", heading: "FUIT JELLYFIN", url: "https://nightlife-our-youth-student.trycloudflare.com/web/", embed: true },
              ...
              <>
                ...
                {(activeLiveTvOption.id === "jellyfin" || activeLiveTvOption.id === "athf") && (
                  <LiveChatBox
                    ...
                    src="https://preceding-opponent-forecasts-coat.trycloudflare.com/chat-only"
