      ...
      <style>{`
        ...
        @media (hover: hover) and (pointer: fine) and (max-width: 1400px) and (max-height: 790px),
          ...
          :root {
            ...
            --flive-tv-content-scale: .78;
            --flive-tv-button-padding: 5px 8px;
            --flive-tv-button-radius: 9px;
            --flive-tv-button-font-size: 10px;
            --flive-tv-button-line-height: 1.12;
            --flive-tv-button-letter-spacing: .12px;
            --flive-tv-scroll-gap: 6px;
            --flive-tv-scroll-padding: 6px 2px 5px;
            --flive-tv-heading-font-size: 12px;
            --flive-tv-heading-line-height: 1.24;
            --flive-tv-channel-controls-gap: 5px;
            --flive-tv-channel-select-height: 44px;
            --flive-tv-channel-select-display-padding: 3px 38px 3px 10px;
            --flive-tv-channel-select-font-size: 10px;
            --flive-tv-channel-select-line-height: 1.12;
            --flive-tv-owner-controls-gap: 5px;
            --flive-tv-owner-controls-margin-top: 5px;
            --flive-tv-owner-button-min-height: 30px;
            --flive-tv-owner-button-padding: 7px 6px;
            --flive-tv-owner-button-font-size: 10px;
            --flive-tv-owner-button-line-height: 1.12;
            --flive-tv-video-shell-height: 136px;
            ...
            --flive-tv-video-title-line-height: 1.16;
            --flive-tv-video-title-overflow: hidden;
            --flive-tv-chat-flex: 0 0 325px;
            --flive-tv-chat-height: 325px;
            --flive-tv-chat-min-height: 325px;
            --flive-tv-chat-max-height: 325px;
