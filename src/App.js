...
export default function App() {
  ...
  const pageBackground = theme.id === "custom" && customBackground
    ? `linear-gradient(rgba(0,0,0,0.28), rgba(0,0,0,0.34)), url(${customBackground})`
    : theme.appBg;
  const appTextColor = isDarkTheme ? theme.headerText : theme.text;
  const dayCardBg = isDarkTheme ? "rgba(255,255,255,0.09)" : theme.cardBg;
            ...
            <div style={{ marginTop: 14, background: theme.statsBg, borderRadius: 12, padding: "14px 16px", boxShadow: theme.shadow, border: `1px solid ${theme.line}`, ...glassStyle }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
                ...
                {weekPay && (
                  <div style={{ textAlign: "right" }}>
                    ...
                    <div style={{ fontSize: 24, color: accentColor, marginTop: 2, fontFamily: "Georgia, serif" }}><AnimatedMoney value={weekPay} /></div>
                    {overtimeMins > 0 && (
                      <div style={{ fontSize: 11, color: "#aaa", marginTop: 2, fontFamily: "system-ui" }}>
              ...
              <div style={{
                ...
                <div style={{ textAlign: "center" }}>
                  ...
                  <div style={{ fontSize: 18, color: overtimeMins > 0 ? accentColor : "#aaa", marginTop: 2, fontFamily: "Georgia, serif" }}>
            ...
            return (
              ...
              >
                <div style={{ width: 52, flexShrink: 0 }}>
                  <div style={{ fontSize: 13, fontWeight: "bold", color: today_ ? theme.headerText : dayCardText, fontFamily: "system-ui" }}>{DAYS[i]}</div>
                  <div style={{ fontSize: 11, color: today_ ? "#888" : "#bbb", fontFamily: "system-ui" }}>{formatDate(date)}</div>
                </div>
                <div style={{ flex: 1, marginLeft: 12 }}>
                  {hasEntry ? (
                    <div>
                      <div style={{ fontSize: 14, color: today_ ? theme.headerText : dayCardText, fontFamily: "system-ui" }}>
