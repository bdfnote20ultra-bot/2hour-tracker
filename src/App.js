...
function MusicLibrarySidebar({ accentColor }) {
  ...
  useEffect(() => {
    ...
    const checkOwncastStatus = async () => {
      try {
        const response = await fetch("https://alternatively-survivor-acm-expect.trycloudflare.com/api/status", { cache: "no-store" });
  ...
  const liveTvOptions = [
    ...
    { id: "jellyfin", label: "FUIT JELLYFIN", heading: "FUIT JELLYFIN", url: "https://ins-optimum-minimum-examples.trycloudflare.com/web/", embed: true },
              ...
              <>
                ...
                {(activeLiveTvOption.id === "jellyfin" || activeLiveTvOption.id === "athf") && (
                  <LiveChatBox
                    ...
                    src="https://seq-thesaurus-bedding-core.trycloudflare.com/chat-only"
