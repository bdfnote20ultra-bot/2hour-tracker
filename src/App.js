      ...
      <style>{`
        ...
        @media (hover: none) and (pointer: coarse) and (orientation: landscape) and (max-width: 1100px) and (max-height: 560px) {
          :root {
            ...
            --flive-center-header-padding: 8px 12px 14px;
            --flive-center-header-row-margin-bottom: 5px;
            ...
            --flive-center-soundtrack-margin: -1px 0 6px;
            --flive-center-soundtrack-gap: 4px;
            --flive-center-soundtrack-padding: 4px 9px;
            --flive-center-soundtrack-font-size: 10px;
            --flive-center-logo-margin: -2px 0 7px;
            --flive-center-logo-max-width: 190px;
            --flive-center-logo-max-height: 60px;
            --flive-center-week-margin-bottom: 6px;
            ...
            --flive-center-stats-margin-top: 6px;
            --flive-center-stats-padding: 9px 10px;
            --flive-center-stats-gap: 6px;
            --flive-center-stat-label-font-size: 8.5px;
            --flive-center-stat-small-font-size: 8.5px;
            --flive-center-stat-value-font-size: 16px;
            --flive-center-mini-stat-value-font-size: 13px;
            --flive-center-stat-value-margin-top: 0px;
            --flive-center-stats-detail-margin-top: 6px;
            --flive-center-stats-detail-padding-top: 6px;
